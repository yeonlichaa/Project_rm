    ...
    <div class="section section-basic">
      <div class="container">
        ...
        <div class="cd-section">
          ...
          <a href="U_Residence1.php"><button class="btn btn-primary waves-effect waves-light">ที่อยู่อาศัย(เป็นเจ้าของที่ดินและสิ่งปลูกสร้าง)</button></a>
          <a href="U_Residence2.php"><button class="btn btn-success waves-effect waves-light">ที่อยู่อาศัย(เป็นเจ้าของเฉพาะสิ่งปลูกสร้าง)</button></a>
          <a href="U_Residence3.php"><button class="btn btn-warning waves-effect waves-light">ที่อยู่อาศัย(บ้านหลังอื่นๆ)</button></a>
        </div>
        <div>
