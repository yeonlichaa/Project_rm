                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">จัดการข้อมูลสมาชิกและแอดมิน</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">จัดการข้อมูลสมาชิกและแอดมิน</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                        <h4>แก้ไขรายชื่อ</h4>
                                            <form name="member" action="m_form_edit_db.php" method="POST" id="member" class="form-horizontal">
                                                <input type="hidden" name="m_id" value="<?php echo $m_id; ?>">
                                                <div class="form-group">
                                                    <div class="col-sm-12" align="left">
                                                        <label>username
                                                            <input name="m_username" type="text" required class="form-control" id="m_username" value="<?php echo $m_username; ?>" placeholder="username" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-12" align="left">
                                                        <label>First Name
                                                            <input name="m_fname" type="text" required class="form-control" name="m_fname" value="<?php echo $m_fname; ?>" placeholder="ชื่อจริง" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-12" align="left">
                                                        <label>Last Name
                                                            <input name="m_lname" type="text" required class="form-control" id="m_lname" value="<?php echo $m_lname; ?>" placeholder="นามสกุล" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-12" align="left">
                                                        <label>ประเภทผู้ใช้งาน
                                                            <input name="m_level" type="text" required class="form-control" id="m_level" value="<?php echo $m_level; ?>" placeholder="ประเภทผู้ใช้งาน" />
                                                    </div>
                                                </div>
