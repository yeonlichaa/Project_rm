    ...
    <div class="section section-basic">
      <div class="container">
        ...
        <div class="cd-section">
          ...
          <a href="U_Residence.php"><button class="btn btn-primary waves-effect waves-light">ที่อยู่อาศัย</button></a>
          <a href="U_Agriculture.php"><button class="btn btn-success waves-effect waves-light">เกษตรกรรม</button></a>
          <a href="U_Industry.php"><button class="btn btn-warning waves-effect waves-light">อุตสาหกรรม</button></a>
          <a href="U_Wasteland.php"><button class="btn btn-info waves-effect waves-light">ที่ดินรกร้าง</button></a>
        </div>
        <div>
            <a href="user.php"><button class="btn btn-danger waves-effect waves-light">ย้อนกลับ</button></a>
        </div>
        <!--                 end buttons		         -->
      </div>
    </div>
