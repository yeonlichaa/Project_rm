            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" method="post" action="registersave.php">
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" name="m_username" class="form-control" required="required">
                                        <span class="form-bar"></span>
                                        <label class="float-label">Username</label>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="text" name="m_fname" class="form-control" required="required">
                                        <span class="form-bar"></span>
                                        <label class="float-label">First Name</label>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="text" name="m_lname" class="form-control" required="required">
                                        <span class="form-bar"></span>
