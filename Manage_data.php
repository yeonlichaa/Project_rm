...
$query = "SELECT * FROM tb_member ORDER BY m_id ASC" or die("Error:" . mysqli_error());
                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                        <table border="5" class="display table table-bordered" id="example1" align="center">
                                            <thead>
                                                <tr class="info">
                                                <th>ID</th>
                                                <th>Username</th>
                                            ...
                                            <?php do { ?>
                                                ...
                                                <td><?php echo $row_am['m_username']; ?></td>
                                                <td><?php echo $row_am['m_fname']; ?></td>
                                                <td><?php echo $row_am['m_lname']; ?></td>
                                                <td><a href="m_form_edit.php?act=edit&ID=<?php echo $row_am['m_id']; ?>" class="btn btn-warning btn-xs"> Edit </a> </td>
                                                <td><a href="m_delete.php?ID=<?php echo $row_am['m_id']; ?>" class='btn btn-danger btn-xs' onclick="return confirm('ยืนยันการลบ')">Delete</a> </td>
                                                </tr>
