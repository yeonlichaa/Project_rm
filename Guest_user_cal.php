    ...
    <div class="section section-basic">
      <div class="container">
        ...
        <div class="cd-section">
          ...
          <a href="U_Residence.php"><h2><button class="btn btn-success waves-effect waves-light">คำนวณภาษีที่ดิน</button></h2></a>
          <button class="btn btn-success waves-effect waves-light">เกษตรกรรม</button>
          <button class="btn btn-warning waves-effect waves-light">อุตสาหกรรม</button>
          <button class="btn btn-info waves-effect waves-light">ที่ดินรกร้าง</button>
          </div>
